(function () {
...
})()(
    {
        ...
        10: [
            ...
            { '../helpers/typeof': 13, './assertThisInitialized': 1 },
        ],
        11: [
            function (require, module, exports) {
        ...
        16: [
            function (require, module, exports) {
                ...
                class SR5Actor extends Actor {
                    ...
                    prepareData() {
                        ...
                        for (let item of Object.values(items)) {
                            ...
                            if (item.type === 'device' && ((_b = itemData.technology) === null || _b === void 0 ? void 0 : _b.equipped)) {
                                ...
                                matrix.condition_monitor.value =
                                    ((_d = itemData.technology.condition_monitor) === null || _d === void 0 ? void 0 : _d.value) || 0;
                        ...
                        limits.mental.value =
                            Math.ceil((2 * attributes.logic.value + attributes.intuition.value + attributes.willpower.value) / 3) + modifiers['mental_limit'];
                        limits.social.value =
                    ...
                    findLimitFromAttribute(attributeName) {
                        ...
                        if (!(attribute === null || attribute === void 0 ? void 0 : attribute.limit)) return undefined;
                    ...
                    rollSkill(skill, options) {
                        ...
                        if (options === null || options === void 0 ? void 0 : options.attribute) att = this.data.data.attributes[options.attribute];
                        let limit = this.data.data.limits[att.limit];
                        const parts = {};
                        parts[skill.label] = skill.value;
                        if (
                            (options === null || options === void 0 ? void 0 : options.event) &&
                            helpers_1.Helpers.hasModifiers(options === null || options === void 0 ? void 0 : options.event)
                        ) {
            ...
            { '../helpers': 29, '../rolls/ShadowrunRoller': 38 },
        ],
        17: [
            function (require, module, exports) {
                'use strict';
                ...
                class SR5ActorSheet extends ActorSheet {
                    ...
                    _doesSkillContainText(key, skill, text) {
                        var _a;
                        let searchString = `${key} ${game.i18n.localize(skill.label)} ${
                            (_a = skill === null || skill === void 0 ? void 0 : skill.specs) === null || _a === void 0 ? void 0 : _a.join(' ')
                        }`;
                    ...
                    _prepareItems(data) {
                        ...
                        const sortByEquipped = (left, right) => {
                            var _a, _b, _c, _d;
                            const leftEquipped =
                                (_b = (_a = left.data) === null || _a === void 0 ? void 0 : _a.technology) === null || _b === void 0 ? void 0 : _b.equipped;
                            const rightEquipped =
                                (_d = (_c = right.data) === null || _c === void 0 ? void 0 : _c.technology) === null || _d === void 0 ? void 0 : _d.equipped;
                    ...
                    activateListeners(html) {
                        ...
                        html.find('.matrix-condition-value').on('change', (event) =>
                            __awaiter(this, void 0, void 0, function* () {
                                event.preventDefault();
                                console.log(event);
            ...
            {
                '../apps/chummer-import-form': 18,
                '../apps/skills/KnowledgeSkillEditForm': 21,
                '../apps/skills/LanguageSkillEditForm': 22,
                '../apps/skills/SkillEditForm': 23,
                '../helpers': 29,
            },
        ],
        18: [
                                                                ...
                                                                case 0:
                                                                    ...
                                                                    parseDamage = function parseDamage(val) {
                                                                        ...
                                                                        for (var i = 1; i < split.length; i++) {
                                                                            ...
                                                                            if (_l && _l[2]) {
                                                                                if (_l[2].toLowerCase().includes('/m')) damage.dropoff = parseInt(_l[1]);
                                                                                else damage.radius = parseInt(_l[1]);
                                                                            }
                                                                        }
                                                                                ...
                                                                                try {
                                                                                    ...
                                                                                    if (w.type.toLowerCase() === 'melee') {
                                                                                        ...
                                                                                        if (w.clips != null && w.clips.clip != null) {
                                                                                            ...
                                                                                            var clips = Array.isArray(w.clips.clip)
                                                                                                ? w.clips.clip
                                                                                                : [w.clips.clip];
     ...
     */
                ...
                class SkillEditForm extends BaseEntitySheet {
                    ...
                    get title() {
                        ...
                        return `${game.i18n.localize('SR5.EditSkill')} - ${
                            (data === null || data === void 0 ? void 0 : data.label) ? game.i18n.localize(data.label) : ''
                        }`;
                    }
                    _onUpdateObject(event, formData, updateData) {
                        // get base value
                        ...
                        const currentData = updateData[this._updateString()] || {};
                        updateData[this._updateString()] = Object.assign(Object.assign({}, currentData), { base, specs, bonus });
                    }
                    /** @override */
        ...
        25: [
            function (require, module, exports) {
                ...
                exports.createChatData = (templateData, roll) =>
                ...
                exports.addRollListeners = (app, html) => {
                    ...
                    if ((item === null || item === void 0 ? void 0 : item.hasRoll) && app.isRoll) $(html).find('.card-description').hide();
                };
            },
            { './actor/SR5Actor': 16, './item/SR5Item': 31, './template': 40 },
        ],
        26: [
            function (require, module, exports) {
                'use strict';
                    ...
                    action: (data, labels, props) => {
                        if (data.action) {
                            ...
                            if (data.action.opposed.type) {
                                ...
                                if (opposed.type !== 'custom') labels.opposedRoll = `vs. ${helpers_1.Helpers.label(opposed.type)}`;
                                ...
                                else if (opposed.attribute) labels.opposedRoll = `vs. ${helpers_1.Helpers.label(opposed.attribute)}`;
                            }
                            // setup action props
                    ...
                    weapon: (data, labels, props, item) => {
                        ...
                        if (data.category === 'range') {
                            ...
                            if (data.thrown.ranges) {
                                const mult =
                                    data.thrown.ranges.attribute && (item === null || item === void 0 ? void 0 : item.actor)
        ...
        31: [
                ...
                class SR5Item extends Item {
                    ...
                    prepareData() {
                        ...
                        if (action) {
                            ...
                            if (this.actor) {
                                if (action.damage.attribute) {
                                    ...
                                    action.damage.mod[game.i18n.localize(CONFIG.SR5.attributes[attribute])] =
                                        (_a = this.actor.findAttribute(attribute)) === null || _a === void 0 ? void 0 : _a.value;
                                    action.damage.value = action.damage.base + helpers_1.Helpers.totalMods(action.damage.mod);
                                }
                                if (action.limit.attribute) {
                                    const { attribute } = action.limit;
                                    // TODO convert this in the template
                                    action.limit.mod[game.i18n.localize(CONFIG.SR5.limits[attribute])] =
                                        (_b = this.actor.findLimit(attribute)) === null || _b === void 0 ? void 0 : _b.value;
                                    action.limit.value = action.limit.base + helpers_1.Helpers.totalMods(action.limit.mod);
                                }
                            }
                        }
                        if (range) {
                            if (range.rc) {
                                ...
                                if (range.rc) range.rc.value = range.rc.base + helpers_1.Helpers.totalMods(range.rc.mod);
                            }
                        }
                    ...
                    getEquippedAmmo() {
                        return (this.items || []).filter((item) => {
                            ...
                            return (
                                item.type === 'ammo' &&
                                ((_b = (_a = item.data.data) === null || _a === void 0 ? void 0 : _a.technology) === null || _b === void 0
                                    ? void 0
                                    : _b.equipped)
                            );
                        })[0];
                    ...
                    calculateRecoil() {
                        var _a;
                        return Math.min(
                            this.getRecoilCompensation(true) - (((_a = this.getLastFireMode()) === null || _a === void 0 ? void 0 : _a.value) || 0),
                            0,
                        );
                    }
                    ...
                    isGrenade() {
                        ...
                        return (
                            ...
                            ((_b = (_a = this.data.data.thrown) === null || _a === void 0 ? void 0 : _a.blast) === null || _b === void 0 ? void 0 : _b.radius)
                        );
                    }
                    isCombatSpell() {
                    ...
                    getAttackData(hits) {
                        var _a;
                        if (!((_a = this.data.data.action) === null || _a === void 0 ? void 0 : _a.damage)) return undefined;
                    ...
                    getActionSpecialization() {
                        var _a;
                        if ((_a = this.data.data.action) === null || _a === void 0 ? void 0 : _a.spec) return 'SR5.Specialization';
                        return undefined;
                    }
                    getDrain() {
                    ...
                    hasExplosiveAmmo() {
                        ...
                        return (
                            ((_c =
                                (_b = (_a = ammo === null || ammo === void 0 ? void 0 : ammo.data) === null || _a === void 0 ? void 0 : _a.data) === null ||
                                _b === void 0
                                    ? void 0
                                    : _b.blast) === null || _c === void 0
                                ? void 0
                                : _c.radius) > 0
                        );
                    }
                    hasDefenseTest() {
                        var _a, _b;
                        return (
                            ((_b = (_a = this.data.data.action) === null || _a === void 0 ? void 0 : _a.opposed) === null || _b === void 0
                                ? void 0
                                : _b.type) === 'defense'
                        );
                    }
            ...
            { '../apps/dialogs/ShadowrunItemDialog': 19, '../chat': 25, '../helpers': 29, '../rolls/ShadowrunRoller': 38, '../template': 40, './ChatData': 30 },
        ],
        32: [
            function (require, module, exports) {
                'use strict';
        ...
        33: [
            ...
            {
                './actor/SR5Actor': 16,
                './actor/SR5ActorSheet': 17,
                './apps/gmtools/OverwatchScoreTracker': 20,
                './canvas': 24,
                './chat': 25,
                './combat': 26,
                './config': 27,
                ...
                './helpers': 29,
                './item/SR5Item': 31,
                './item/SR5ItemSheet': 32,
                './migrator/Migrator': 34,
                './rolls/ShadowrunRoller': 38,
                './settings': 39,
            },
        ],
        34: [
                    ...
                    static BeginMigration() {
                        return __awaiter(this, void 0, void 0, function* () {
                            let currentVersion = game.settings.get(
                                VersionMigration_1.VersionMigration.MODULE_NAME,
                                VersionMigration_1.VersionMigration.KEY_DATA_VERSION,
                            );
                    ...
                    static migrateCompendium(game, migrations) {
                        return __awaiter(this, void 0, void 0, function* () {
                            ...
                            const packs = game.packs.filter(
                                (pack) => pack.metadata.package === 'world' && ['Actor', 'Item', 'Scene'].includes(pack.metadata.entity),
                            );
            ...
            { './VersionMigration': 35, './versions/LegacyMigration': 36, './versions/Version0_6_5': 37 },
        ],
        35: [
            function (require, module, exports) {
                'use strict';
            ...
            function (require, module, exports) {
                ...
                class LegacyMigration extends VersionMigration_1.VersionMigration {
                    ...
                    static migrateActorSkills(actorData, updateData) {
                        ...
                        updateData['data.skills.knowledge.professional.value'] = Object.entries(actorData.data.skills.knowledge.professional.value).reduce(
                            reducer,
                            {},
                        );
                        ...
                        updateData['data.skills.knowledge.interests.value'] = Object.entries(actorData.data.skills.knowledge.interests.value).reduce(
                            reducer,
                            {},
                        );
            ...
            function (require, module, exports) {
                ...
                class ShadowrunRoller {
                    static itemRoll(event, item, options) {
                        ...
                        const rollData = Object.assign(Object.assign({}, options), {
                            event: event,
                            dialogOptions: {
                                environmental: true,
                            },
                    ...
                    static basicRoll(_a) {
                        var {
                            ...
                            props = __rest(_a, ['parts', 'limit', 'explodeSixes', 'title', 'actor', 'img', 'name', 'hideRollMessage']);
                        return __awaiter(this, void 0, void 0, function* () {
                            let roll;
                            const rollMode = game.settings.get('core', 'rollMode');
                            ...
                            const templateData = Object.assign(
                                {
                                    ...
                                    parts,
                                    hits: roll === null || roll === void 0 ? void 0 : roll.total,
                                },
                                props,
                            );
